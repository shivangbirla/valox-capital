...
import { FAQ, DISCLOSURES } from "@/lib/constants";
        ...
        <div className="container relative flex min-h-[86vh] flex-col items-center justify-center py-24 text-center">
          ...
          <Reveal delay={0.1}>
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Valox Capital actively manages and compounds your capital —
              pairing seasoned market judgment with AI-augmented research. No
              management fees, no lock-in, and T+1 (next-business-day)
              liquidity.
            </p>
          </Reveal>
        ...
        <div className="mx-auto mb-10 max-w-2xl text-center">
          <Reveal>
            ...
            <p className="mt-4 text-muted-foreground">
              Full transparency on how the Valox Dynamic Compounding strategy is
              performing — no black box, no waiting for a monthly statement.
            </p>
          </Reveal>
        </div>
        <Reveal delay={0.05}>
          ...
          <div>
            <Reveal>
              ...
              <p className="mt-5 text-pretty leading-relaxed text-muted-foreground">
                Markets generate more data than any individual can read. We pair
                fifteen-plus years of hands-on experience with AI-augmented
                research — systematic screening across the Nifty 100, signal
                processing that surfaces shifts in momentum and risk, and faster
                synthesis of the information that moves prices. The models
                inform; experienced people decide. Every position stays under
                human oversight.
              </p>
            </Reveal>
          </div>
            ...
            <div className="relative">
              ...
              <div className="glass relative grid gap-4 rounded-3xl p-7 sm:grid-cols-2">
                {[
                  {
                    icon: Cpu,
                    t: "Systematic screening",
                    d: "Across the Nifty 100, continuously.",
                  },
                  {
                    icon: Sparkles,
                    t: "Signal processing",
                    d: "Surfacing momentum and risk shifts.",
                  },
                  {
                    icon: ShieldCheck,
                    t: "Human oversight",
                    d: "People decide on every position.",
                  },
                  {
                    icon: TrendingUp,
                    t: "Faster synthesis",
                    d: "Acting on what moves prices.",
                  },
                ].map((b) => (
                  <div
                    key={b.t}
      ...
      <Section>
        <div className="max-w-2xl">
          <Reveal>
            ...
            <p className="mt-5 text-pretty leading-relaxed text-muted-foreground">
              We don&apos;t promise outperformance — no one credibly can. But
              the structure of how Valox invests is deliberately designed to
              remove the frictions that quietly erode standard investment
              returns:
            </p>
          </Reveal>
        </div>
        ...
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <p className="mt-5 text-pretty text-lg leading-relaxed text-muted-foreground">
              Over 15+ years, our team has invested across the Indian stock
              market and every major sector, with a focus on Nifty 100 companies
              — building the judgement that only comes from real time in the
              market, and now amplifying it with modern, data-driven tools.
            </p>
          </Reveal>
        </div>
      </Section>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="text-center">
            <Reveal>
              ...
              <p className="mt-4 text-muted-foreground">
                Tell us a little about your goals and we&apos;ll be in touch. No
